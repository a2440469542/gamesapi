...
class Api
{
    const NO_LOGIN_ACTIONS = ['index.index','index.ad','index.jack_pot','index.channel','index.config','game.get_plate','game.get_game_list','login.register','login.user_login'];
